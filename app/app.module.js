        ...
        .config(function(
            ...
            $stateProvider
                .state('account', {
                    ...
                    resolve: {
                        loggedIn: function(AuthService, $state) {
                        ...
                        user: function(classifiedsFactory) {
                            return classifiedsFactory.getUser();
                        },
                        userClassifieds: function(classifiedsFactory) {
                            return classifiedsFactory.getUserClassifieds();
                        }
                    }
                })
                .state('account.edit', {
                ...
                .state('classifieds', {
                    ...
                    resolve: {
                        classifieds: function(classifiedsFactory) {
                            return classifiedsFactory.getClassifieds();
                        }
                    }
                })
